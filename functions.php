...
function _s_scripts() {
	...
	wp_enqueue_script( '_s-toggles', get_template_directory_uri() . '/js/toggle.js', array(), _S_VERSION, true );
...
function passing_ads_txt_url ( $url_queue ) {
    $url_queue[] = '/netlify.toml';
    return $url_queue;
}
add_filter( 'wp2static_modify_initial_crawl_list', 'passing_ads_txt_url' );
